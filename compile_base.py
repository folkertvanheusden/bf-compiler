...
class CompileBase:
    ...
    copyrightNotice = [ 'This code was generated by the', 'Brainfuck to * compiler suite', 'written by', 'Folkert van Heusden', 'folkert@vanheusden.com / www.vanheusden.com', '(C) 2016-2025 by Folkert van Heusden', 'Released in the public domain' ]
    ...
    def main(self, file):
        print('(C) 2016-2025 by Folkert van Heusden <folkert@vanheusden.com>', file=sys.stderr)
